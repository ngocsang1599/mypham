                    ...
                    <div class="details-product">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-7 details-pro">
                                <h1 class="title-head"><?php echo $data->name; ?></h1>
                                ...
                                <div class="price-box clearfix">
                                    <div class="special-price"> <span class="price product-price"> <?php echo number_format($data->price) ?>  vnđ</span> </div>
                                ...
                                <div id="product" class="form-product">
                                    <div class="margin-bottom-10 dqdt-form form">
                                        ...
                                        <div class="form-group form-groupx form-detail-action clearfix">
                                            <button class="btn btn-lg btn-primary btn-cart btn-cart2 add_to_cart btn_buy add_to_cart" type="button" id="button-cart" data-loading-text="Đang tải..."> <span> Liên hệ Mua hàng <i class="fa .fa-caret-right"></i></span> </button>
                                        </div>
                                    </div>
