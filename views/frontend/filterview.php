                                ...
                                <h2 class="title-head"> <span>Danh mục sản phẩm</span> </h2> </div>  
                                        ...
                                        <div class="aside-content filter-group">
                                            <ul id="filter-group-price">
                                                <li class=" filter-item filter-item--check-box filter-item--green"> <span> <label > <input type="radio" value="0" onclick="loadFilter('all')" checked="checked" /> <i class="fa"></i> Tất cả </label> </span> </li>
                                                <li class=" filter-item filter-item--check-box filter-item--green"> <span> <label> <input type="radio" value="1" onclick="loadFilter('b')" /> <i class="fa"></i> Dưới 100k </label> </span> </li>
                                                <li class=" filter-item filter-item--check-box filter-item--green"> <span> <label> <input type="radio"  value="2" onclick="loadFilter('c')" /> <i class="fa"></i> Từ 100k - 200k </label> </span> </li>
                                                <li class=" filter-item filter-item--check-box filter-item--green"> <span> <label> <input type="radio" value="3" onclick="loadFilter('d')" /> <i class="fa"></i> Từ 200k - 500k </label> </span> </li>
                                                <li class=" filter-item filter-item--check-box filter-item--green"> <span> <label> <input type="radio" value="4" onclick="loadFilter('e')" /> <i class="fa"></i> Trên 500k </label> </span> </li>
                                            </ul>
                                        </div>
                                    </aside>
