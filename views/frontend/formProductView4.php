	    ...
	    <div class="col-sm-12">
	        <div class="product-mini-item clearfix">
	            ...
	            <div class="product-info">
	                <h3> <a href="index.php?area=frontend&controller=chitiet&id=<?php echo $rows->id; ?>&category_id=<?php echo $rows->category_id; ?>" title="<?php echo $rows->name ?>" class="product-name" > <span ><?php echo $rows->name ?></span> </a> </h3>
	                <div class="price-box">
